...
%     title(['real and imaginary part of psi from t=0 to t=8 for n=' num2str(a) ' (4 plots per second) '],'Fontsize', 24)
    title(['real and imaginary part of psi for n=' num2str(a) ''])
    axis([-10 10 -2 2])
...
%     plot(x,pd,'-k')
%     xlabel('x','Fontsize', 24)
%     title(['Probability density from t=0 to t=8 for n=' num2str(a) '','Fontsize', 24])
%     axis([-10 10 -2 2])
%     legend('prob. density')
%     set(gca,'fontsize',20)
    drawnow
